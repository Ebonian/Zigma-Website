...
import SubmitPopup from "../components/Signup/SubmitPopup";

function SubmitPage() {
  return (
    <SignupContainer>
      <SubmitPopup trigger={true} />
      <LogoWrapper>
        <Logo to="/">ZIGMA</Logo>
      </LogoWrapper>
      <SignupWrapper>
          ...
          <Column2>
            <TextWrapper>
              ...
              <Subtitle>
                ...
                <br />
                So sign yourself up using your preferred email and get ready for
                the release. We will send the announcement to you right away!
              </Subtitle>
